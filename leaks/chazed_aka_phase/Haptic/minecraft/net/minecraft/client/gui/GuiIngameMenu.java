    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        switch (button.id)
        {
            ...
            case 1:
                ...
                if (flag)
                {
                    this.mc.displayGuiScreen(new HapticMainMenu());
                }
                else if (flag1)
                {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(new HapticMainMenu());
                }
                else
                {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new HapticMainMenu()));
                }
