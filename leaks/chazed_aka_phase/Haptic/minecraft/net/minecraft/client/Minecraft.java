...
import haptic.ui.menu.HapticMainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public Timer timer = new Timer(20.0F); // was private
    ...
    public Session session; // was private and final
    ...
    public int leftClickCounter; // was private
     ...
     */
    public int rightClickDelayTimer; // was private
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new HapticMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new HapticMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new HapticMainMenu();
        }
        ...
        if (guiScreenIn instanceof HapticMainMenu)
        {
    ...
    public void clickMouse() // was private
    {
