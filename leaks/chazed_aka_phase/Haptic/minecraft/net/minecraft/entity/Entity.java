...
public abstract class Entity implements ICommandSender
{
    ...
    public AxisAlignedBB boundingBox; // was private
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            boolean shouldSafeWalk = Haptic.getModuleManager().getModuleByName("Scaffold").isEnabled() || Haptic.getModuleManager().getModuleByName("AutoBridge").isEnabled();
            boolean onlyOnGround = Haptic.getModuleManager().getModuleByName("Scaffold").isEnabled() ? true : false;
            
            boolean flag = (this.onGround && this.isSneaking() && this instanceof EntityPlayer) || (this instanceof EntityPlayer && shouldSafeWalk && (this.onGround || !onlyOnGround));
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
    	if(this.equals(Minecraft.getMinecraft().thePlayer)) {
    		EventStrafing event = new EventStrafing(this.rotationYaw);
    		event.call();
     ...
     */
    public final static Vec3 getVectorForRotation(float pitch, float yaw) // was protected and not static
    {
