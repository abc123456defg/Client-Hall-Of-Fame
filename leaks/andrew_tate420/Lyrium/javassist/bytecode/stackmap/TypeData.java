...
public abstract class TypeData
{
    ...
    public abstract int getTypeData(final ConstPool cp);
    ...
    public abstract boolean eq(final TypeData d);
    
    public abstract String getName();
    
    public abstract void setType(final String s, final ClassPool cp) throws BadBytecode;
    ...
    {
        public abstract void merge(final TypeData t);
