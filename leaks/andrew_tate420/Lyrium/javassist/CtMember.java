...
public abstract class CtMember
{
    ...
    protected abstract void extendToString(final StringBuffer buffer);
    ...
    public abstract void setModifiers(final int mod);
    
    public abstract boolean hasAnnotation(final Class clz);
    
    public abstract Object getAnnotation(final Class clz) throws ClassNotFoundException;
    ...
    public abstract void setGenericSignature(final String sig);
    
    public abstract byte[] getAttribute(final String name);
    
    public abstract void setAttribute(final String name, final byte[] data);
