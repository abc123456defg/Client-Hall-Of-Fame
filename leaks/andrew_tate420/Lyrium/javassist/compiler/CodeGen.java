...
public abstract class CodeGen extends Visitor implements Opcode, TokenId
{
    ...
    protected abstract String resolveClassName(final ASTList name) throws CompileError;
    
    protected abstract String resolveClassName(final String jvmClassName) throws CompileError;
    ...
    @Override
    public abstract void atNewExpr(final NewExpr n) throws CompileError;
    
    @Override
    public abstract void atArrayInit(final ArrayInit init) throws CompileError;
    ...
    protected abstract void atArrayVariableAssign(final ArrayInit init, final int varType, final int varArray, final String varClass) throws CompileError;
    ...
    protected abstract void atFieldAssign(final Expr expr, final int op, final ASTree left, final ASTree right, final boolean doDup) throws CompileError;
    ...
    @Override
    public abstract void atCallExpr(final CallExpr expr) throws CompileError;
    
    protected abstract void atFieldRead(final ASTree expr) throws CompileError;
    ...
    protected abstract void atFieldPlusPlus(final int token, final boolean isPost, final ASTree oprand, final Expr expr, final boolean doDup) throws CompileError;
    
    @Override
    public abstract void atMember(final Member n) throws CompileError;
    ...
    protected abstract static class ReturnHook
    {
        ...
        protected abstract boolean doit(final Bytecode b, final int opcode);
