...
public class CtField extends CtMember
{
    ...
    public abstract static class Initializer
    {
        ...
        abstract int compile(final CtClass type, final String name, final Bytecode code, final CtClass[] parameters, final Javac drv) throws CannotCompileException;
        
        abstract int compileIfStatic(final CtClass type, final String name, final Bytecode code, final Javac drv) throws CannotCompileException;
    ...
    {
        abstract void compileExpr(final Javac drv) throws CompileError;
