...
public class RealmsMainScreen extends RealmsScreen
{
            ...
            new Thread("MCO Availability Checker #1") {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e2.getMessage(), RealmsMainScreen.this.lastScreen));
                        return;
                    }
                    boolean retry = false;
                    for (int i = 0; i < 3; ++i) {
    ...
    private void leaveClicked() {
        ...
        if (selectedServer != null && !Realms.getUUID().equals(selectedServer.ownerUUID)) {
            this.saveListScrollPosition();
            final String line2 = getLocalizedString("mco.configure.world.leave.question.line1");
            final String line3 = getLocalizedString("mco.configure.world.leave.question.line2");
    ...
    private void drawInvitationPendingIcon(final int xm, final int ym) {
        ...
        if (hovering) {
            final int rx = xm + 12;
            final int ry = ym - 12;
            final String message = (pendingInvitesCount == 0) ? getLocalizedString("mco.invites.nopending") : getLocalizedString("mco.invites.pending");
    ...
    public void play(final RealmsServer server) {
        if (server != null) {
            ...
            if (server.resourcePackUrl != null && server.resourcePackHash != null) {
                ...
                this.saveListScrollPosition();
                final String line2 = getLocalizedString("mco.configure.world.resourcepack.question.line1");
                final String line3 = getLocalizedString("mco.configure.world.resourcepack.question.line2");
    ...
    private void renderLink(final int xm, final int ym) {
        final String text = getLocalizedString("mco.selectServer.whatisrealms");
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
        GL11.glPushMatrix();
