...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen
{
    ...
    private void checkDownloadSize() {
        ...
        if (!this.checked && this.getContentLength(this.downloadLink) >= 1048576000L) {
            final String line1 = getLocalizedString("mco.download.confirmation.line1", new Object[] { humanReadableSize(1048576000L) });
            final String line2 = getLocalizedString("mco.download.confirmation.line2");
