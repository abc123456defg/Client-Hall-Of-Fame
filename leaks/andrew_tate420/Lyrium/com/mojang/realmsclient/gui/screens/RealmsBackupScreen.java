...
public class RealmsBackupScreen extends RealmsScreen
{
    ...
    private void restoreClicked(final int selectedBackup) {
        if (selectedBackup >= 0 && selectedBackup < this.backups.size() && !this.serverData.expired) {
            ...
            final String line2 = getLocalizedString("mco.configure.world.restore.question.line1", new Object[] { datePresentation, age });
            final String line3 = getLocalizedString("mco.configure.world.restore.question.line2");
            Realms.setScreen((RealmsScreen)new RealmsLongConfirmationScreen(this, RealmsLongConfirmationScreen.Type.Warning, line2, line3, true, 1));
        }
    }
    
    private void downloadClicked() {
        final String line2 = getLocalizedString("mco.configure.world.restore.download.question.line1");
        final String line3 = getLocalizedString("mco.configure.world.restore.download.question.line2");
    ...
    private void downloadWorldData() {
        ...
        try {
            ...
            Realms.setScreen((RealmsScreen)new RealmsDownloadLatestWorldScreen(this, downloadLink, this.serverData.name + " (" + this.serverData.slots.get(this.serverData.activeSlot).getSlotName(this.serverData.activeSlot) + ")"));
        }
        catch (RealmsServiceException e) {
        ...
        public void run() {
            ...
            for (int i = 0; i < 6; ++i) {
                try {
                    ...
                    Realms.setScreen((RealmsScreen)RealmsBackupScreen.this.lastScreen.getNewScreen());
                    return;
                }
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e2, RealmsBackupScreen.this.lastScreen));
                    return;
                }
                catch (Exception e3) {
                    if (this.aborted()) {
        ...
        public void itemClicked(final int clickSlotPos, final int slot, final int xm, final int ym, final int width) {
            ...
            if (xm >= infox && xm <= infox + 9 && ym >= infoy && ym <= infoy + 9) {
                if (!RealmsBackupScreen.this.backups.get(slot).changeList.isEmpty()) {
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsBackupInfoScreen(RealmsBackupScreen.this, RealmsBackupScreen.this.backups.get(slot)));
                }
            }
