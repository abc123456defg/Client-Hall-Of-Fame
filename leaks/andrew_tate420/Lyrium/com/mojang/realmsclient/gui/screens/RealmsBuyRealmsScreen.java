...
public class RealmsBuyRealmsScreen extends RealmsScreen
{
    ...
    public void init() {
        ...
        this.buttonsAdd(newButton(RealmsBuyRealmsScreen.BUTTON_BACK_ID, this.width() / 2 - buttonLength / 2, RealmsConstants.row(12), buttonLength, 20, getLocalizedString("gui.back")));
        this.fetchMessage();
    }
