...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback<WorldTemplate>
{
    ...
    public void mouseClicked(final int x, final int y, final int buttonNum) {
        switch (this.selectedType) {
            ...
            case UPLOAD: {
                Realms.setScreen((RealmsScreen)new RealmsSelectFileToUploadScreen(this.serverData.id, (this.slot != -1) ? this.slot : this.serverData.activeSlot, this));
                break;
            }
            case ADVENTURE: {
            ...
            case SURVIVAL_SPAWN: {
                ...
                Realms.setScreen((RealmsScreen)templateScreen);
                break;
            }
            default: {}
        }
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        if (this.loaded) {
            this.drawFrame(this.frame(1), RealmsConstants.row(0) + 10, xm, ym, getLocalizedString("mco.reset.world.generate"), -1L, "textures/gui/title/background/panorama_3.png", ResetType.GENERATE);
            this.drawFrame(this.frame(2), RealmsConstants.row(0) + 10, xm, ym, getLocalizedString("mco.reset.world.upload"), -1L, "realms:textures/gui/realms/upload.png", ResetType.UPLOAD);
            this.drawFrame(this.frame(1), RealmsConstants.row(6) + 20, xm, ym, getLocalizedString("mco.reset.world.adventure"), Long.valueOf(this.adventuremaps.get(this.adventureMapId).id), this.adventuremaps.get(this.adventureMapId).image, ResetType.ADVENTURE);
            this.drawFrame(this.frame(2), RealmsConstants.row(6) + 20, xm, ym, getLocalizedString("mco.reset.world.template"), Long.valueOf(this.templates.get(this.templateId).id), this.templates.get(this.templateId).image, ResetType.SURVIVAL_SPAWN);
        }
