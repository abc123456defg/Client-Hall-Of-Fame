...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen
{
    ...
    private class WorldTemplateSelectionList extends RealmsClickableScrolledSelectionList
    {
        ...
        public void renderSelected(final int width, final int y, final int h, final Tezzelator t) {
            ...
            t.vertex((double)x2, (double)(y + h + 2), 0.0).tex(1.0, 1.0).color(128, 128, 128, 255).endVertex();
            t.vertex((double)x2, (double)(y - 2), 0.0).tex(1.0, 0.0).color(128, 128, 128, 255).endVertex();
            ...
            t.vertex((double)(x2 - 1), (double)(y + h + 1), 0.0).tex(1.0, 1.0).color(0, 0, 0, 255).endVertex();
            t.vertex((double)(x2 - 1), (double)(y - 1), 0.0).tex(1.0, 0.0).color(0, 0, 0, 255).endVertex();
