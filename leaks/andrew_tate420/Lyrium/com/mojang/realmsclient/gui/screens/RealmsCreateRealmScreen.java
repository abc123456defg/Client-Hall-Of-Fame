...
public class RealmsCreateRealmScreen extends RealmsScreen
{
    ...
    public void init() {
        ...
        this.buttonsClear();
        this.buttonsAdd(this.createButton = newButton(RealmsCreateRealmScreen.CREATE_BUTTON, this.width() / 2 - 100, this.height() / 4 + 120 + 17, 97, 20, getLocalizedString("mco.create.world")));
        this.buttonsAdd(newButton(RealmsCreateRealmScreen.CANCEL_BUTTON, this.width() / 2 + 5, this.height() / 4 + 120 + 17, 95, 20, getLocalizedString("gui.cancel")));
    ...
    private void createWorld() {
        if (this.valid()) {
            final RealmsResetWorldScreen resetWorldScreen = new RealmsResetWorldScreen(this.lastScreen, this.server, this.lastScreen.newScreen(), getLocalizedString("mco.selectServer.create"), getLocalizedString("mco.create.world.subtitle"), 10526880, getLocalizedString("mco.create.world.skip"));
