...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback<WorldTemplate>
{
    ...
    public void init() {
        ...
        this.buttonsAdd((RealmsButton)(this.optionsButton = new RealmsHideableButton(5, this.leftButton(0), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, getLocalizedString("mco.configure.world.buttons.options"))));
        this.buttonsAdd((RealmsButton)(this.backupButton = new RealmsHideableButton(6, this.leftButton(1), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, getLocalizedString("mco.configure.world.backup"))));
        this.buttonsAdd((RealmsButton)(this.resetWorldButton = new RealmsHideableButton(7, this.leftButton(2), RealmsConstants.row(13) - 5, this.default_button_width + 10, 20, getLocalizedString("mco.configure.world.buttons.resetworld"))));
        this.buttonsAdd((RealmsButton)(this.switchMinigameButton = new RealmsHideableButton(8, this.leftButton(0), RealmsConstants.row(13) - 5, this.default_button_width + 20, 20, getLocalizedString("mco.configure.world.buttons.switchminigame"))));
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        final int titleWidth = this.fontWidth(getLocalizedString("mco.configure.world.title"));
    ...
    public void confirmResult(final boolean result, final int id) {
        switch (id) {
            ...
            case 10: {
                if (result) {
                    final RealmsResetWorldScreen resetWorldScreen = new RealmsResetWorldScreen(this, this.serverData, this.getNewScreen(), getLocalizedString("mco.configure.world.switch.slot"), getLocalizedString("mco.configure.world.switch.slot.subtitle"), 10526880, getLocalizedString("gui.cancel"));
        ...
        if (buttonNum == 0) {
            ...
            if (this.hoveredSlot != -1) {
                if (this.hoveredSlot < 4) {
                    final String line2 = getLocalizedString("mco.configure.world.slot.switch.question.line1");
                    final String line3 = getLocalizedString("mco.configure.world.slot.switch.question.line2");
                    ...
                    Realms.setScreen((RealmsScreen)new RealmsSelectWorldTemplateScreen(this, null, true, true));
                }
            }
    ...
    private void drawSlotFrame(final int x, final int y, final int xm, final int ym, final boolean active, final String text, final int i, final long imageId, final String image, final boolean empty) {
        if (xm >= x && xm <= x + 80 && ym >= y && ym <= y + 80 && ((!this.isMinigame() && this.serverData.activeSlot != i) || (this.isMinigame() && i != 4))) {
            if (i != 4 || !this.serverData.expired) {
                this.toolTip = (((this.hoveredSlot = i) == 4) ? getLocalizedString("mco.configure.world.slot.tooltip.minigame") : getLocalizedString("mco.configure.world.slot.tooltip"));
            }
        }
    ...
    public void saveSlotSettings() {
        ...
        try {
            ...
            Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e, this));
            return;
        }
