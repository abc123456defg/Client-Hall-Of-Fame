    ...
    class DetailsList extends RealmsScrolledSelectionList
    {
        ...
        protected void renderItem(final int i, final int x, final int y, final int h, final Tezzelator t, final int mouseX, final int mouseY) {
            if (RealmsActivityScreen.this.activityMap != null && RealmsActivityScreen.this.activityMap.size() > i) {
                ...
                GL11.glDisable(3553);
                t.begin(7, RealmsDefaultVertexFormat.POSITION_COLOR);
                t.vertex((double)(RealmsActivityScreen.this.activityPoint - 8), y + 6.5, 0.0).color(r, g, b, 255).endVertex();
                t.vertex((double)(RealmsActivityScreen.this.activityPoint - 3), y + 6.5, 0.0).color(r, g, b, 255).endVertex();
                t.vertex((double)(RealmsActivityScreen.this.activityPoint - 3), y + 1.5, 0.0).color(r, g, b, 255).endVertex();
                t.vertex((double)(RealmsActivityScreen.this.activityPoint - 8), y + 1.5, 0.0).color(r, g, b, 255).endVertex();
                t.end();
                GL11.glEnable(3553);
