...
public class RealmsSlotOptionsScreen extends RealmsScreen
{
    ...
    public void init() {
        ...
        this.buttonsAdd((RealmsButton)(this.spawnProtectionButton = new SettingsSlider(8, this.column1_x, RealmsConstants.row(8), this.column_width, 17, this.spawnProtection, 0.0f, 16.0f)));
    ...
    private String difficultyTitle() {
        final String difficulty = getLocalizedString("options.difficulty");
        return difficulty + ": " + this.difficulties[this.difficultyIndex];
    }
    
    private String gameModeTitle() {
        final String gameMode = getLocalizedString("selectWorld.gameMode");
    ...
    private String spawnMonstersTitle() {
        ...
        return getLocalizedString("mco.configure.world.spawnMonsters") + ": " + (this.spawnMonsters ? getLocalizedString("mco.configure.world.on") : getLocalizedString("mco.configure.world.off"));
    }
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        final String slotName = getLocalizedString("mco.configure.world.edit.slot.name");
