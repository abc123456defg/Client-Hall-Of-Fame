...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    private void loadLevelList() throws Exception {
        ...
        Collections.sort(this.levelList = (List<RealmsLevelSummary>)levelSource.getLevelList());
    }
    ...
    public void init() {
        ...
        try {
            ...
            Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen("Unable to load worlds", e.getMessage(), this.lastScreen));
            return;
        }
