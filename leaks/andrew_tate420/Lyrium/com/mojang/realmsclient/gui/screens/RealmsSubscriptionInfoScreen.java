...
public class RealmsSubscriptionInfoScreen extends RealmsScreen
{
    ...
    private void getSubscription(final long worldId) {
        ...
        try {
            ...
            Realms.setScreen((RealmsScreen)new RealmsGenericErrorScreen(e, this.lastScreen));
        }
    ...
    public void buttonClicked(final RealmsButton button) {
        ...
        if (button.id() == 0) {
            ...
            final String line2 = getLocalizedString("mco.configure.world.delete.question.line1");
            final String line3 = getLocalizedString("mco.configure.world.delete.question.line2");
