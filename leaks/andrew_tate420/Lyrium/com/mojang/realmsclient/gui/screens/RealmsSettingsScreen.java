        ...
        switch (button.id()) {
            ...
            case 5: {
                if (this.serverData.state.equals(RealmsServer.State.OPEN)) {
                    final String line2 = getLocalizedString("mco.configure.world.close.question.line1");
                    final String line3 = getLocalizedString("mco.configure.world.close.question.line2");
                    Realms.setScreen((RealmsScreen)new RealmsLongConfirmationScreen(this, RealmsLongConfirmationScreen.Type.Info, line2, line3, true, 5));
                    break;
                }
