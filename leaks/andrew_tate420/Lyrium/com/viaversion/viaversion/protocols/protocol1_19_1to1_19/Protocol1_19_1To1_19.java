...
public final class Protocol1_19_1To1_19 extends AbstractProtocol<ClientboundPackets1_19, ClientboundPackets1_19_1, ServerboundPackets1_19, ServerboundPackets1_19_1>
{
    ...
    protected void registerPackets() {
        ...
        ((Protocol<ClientboundPackets1_19, ClientboundPackets1_19_1, S1, S2>)this).registerClientbound(ClientboundPackets1_19.PLAYER_CHAT, ClientboundPackets1_19_1.SYSTEM_CHAT, new PacketRemapper() {
            @Override
            public void registerMap() {
                final JsonElement signedContent;
                final JsonElement unsignedContent;
                final int chatTypeId;
                final JsonElement senderName;
                final JsonElement teamName;
                final CompoundTag chatType;
                final ChatDecorationResult decorationResult;
                this.handler(wrapper -> {
                    signedContent = wrapper.read(Type.COMPONENT);
                    unsignedContent = wrapper.read(Type.OPTIONAL_COMPONENT);
                    chatTypeId = wrapper.read((Type<Integer>)Type.VAR_INT);
                    wrapper.read(Type.UUID);
                    senderName = wrapper.read(Type.COMPONENT);
                    teamName = wrapper.read(Type.OPTIONAL_COMPONENT);
                    chatType = wrapper.user().get(ChatTypeStorage.class).chatType(chatTypeId);
                    decorationResult = Protocol1_19_1To1_19.decorateChatMessage(chatType, chatTypeId, senderName, teamName, (unsignedContent != null) ? unsignedContent : signedContent);
        ...
        ((AbstractProtocol<ClientboundPackets1_19, C2, S1, S2>)this).registerClientbound(ClientboundPackets1_19.JOIN_GAME, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                final ChatTypeStorage chatTypeStorage;
                ...
                NumberTag idTag;
                this.handler(wrapper -> {
                    chatTypeStorage = wrapper.user().get(ChatTypeStorage.class);
                    chatTypeStorage.clear();
                    registry = wrapper.passthrough(Type.NBT);
