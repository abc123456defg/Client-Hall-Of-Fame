...
public class ParticleType extends Type<Particle>
{
    ...
    public static final class Readers
    {
        ...
        public static final ParticleReader SCULK_CHARGE;
        public static final ParticleReader SHRIEK;
        ...
        static {
            ...
            SCULK_CHARGE = ((buf, particle) -> particle.add(Type.FLOAT, Type.FLOAT.readPrimitive(buf)));
            SHRIEK = ((buf, particle) -> particle.add(Type.VAR_INT, Type.VAR_INT.readPrimitive(buf)));
        }
    }
