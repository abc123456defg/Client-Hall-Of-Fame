...
public class StringType extends Type<String>
{
    ...
    public String read(final ByteBuf buffer) throws Exception {
        ...
        Preconditions.checkArgument(len <= this.maxLength * StringType.maxJavaCharUtf8Length, "Cannot receive string longer than Short.MAX_VALUE * " + StringType.maxJavaCharUtf8Length + " bytes (got %s bytes)", len);
