...
public class MappingDataLoader
{
    ...
    private static int mapIdentifierEntry(final Map.Entry<String, JsonElement> entry, final Object2IntMap<String> newIdentifierMap, final JsonObject diffIdentifiers, final boolean warnOnMissing) {
