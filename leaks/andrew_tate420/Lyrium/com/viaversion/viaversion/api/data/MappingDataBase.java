...
public class MappingDataBase implements MappingData
{
    ...
    public void load() {
        ...
        this.enchantmentMappings = this.loadFromArray(oldMappings, newMappings, diffmapping, "enchantments");
        this.paintingMappings = this.loadFromArray(oldMappings, newMappings, diffmapping, "paintings");
        this.entityMappings = this.loadFullMappings(oldMappings, newMappings, diffmapping, "entities");
        this.argumentTypeMappings = this.loadFullMappings(oldMappings, newMappings, diffmapping, "argumenttypes");
    ...
    protected FullMappings loadFullMappings(final JsonObject oldMappings, final JsonObject newMappings, final JsonObject diffMappings, final String key) {
        final Mappings mappings = this.loadFromArray(oldMappings, newMappings, diffMappings, key);
    ...
    public int getNewParticleId(final int id) {
        return this.checkValidity(id, this.particleMappings.mappings().getNewId(id), "particles");
    }
