...
public class ProtocolVersion
{
    ...
    private static final List<ProtocolVersion> VERSION_LIST;
    ...
    public static ProtocolVersion register(final int version, final int snapshotVersion, final String name, final VersionRange versionRange) {
        ...
        ProtocolVersion.VERSION_LIST.add(protocol);
    ...
    public static boolean isRegistered(final int version) {
        return ProtocolVersion.VERSIONS.containsKey(version);
    }
    
    public static ProtocolVersion getProtocol(final int version) {
        final ProtocolVersion protocolVersion = ProtocolVersion.VERSIONS.get(version);
    ...
    public static int getIndex(final ProtocolVersion version) {
        return ProtocolVersion.VERSION_LIST.indexOf(version);
    }
    ...
    static {
        ...
        v1_19_1 = register(760, "1.19.1/2", new VersionRange("1.19", 1, 2));
