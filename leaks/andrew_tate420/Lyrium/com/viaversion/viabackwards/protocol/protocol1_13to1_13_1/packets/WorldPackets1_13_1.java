        ...
        protocol.registerClientbound(ClientboundPackets1_13.EFFECT, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    ...
                    if (id == 1010) {
                        wrapper.set(Type.INT, 1, val$protocol.getMappingData().getNewItemId(data));
                    }
                    else if (id == 2001) {
                        wrapper.set(Type.INT, 1, val$protocol.getMappingData().getNewBlockStateId(data));
                    }
                    else if (id == 2000) {
                        switch (data) {
                            case 0:
                            case 1: {
                                pos = wrapper.get(Type.POSITION, 0);
