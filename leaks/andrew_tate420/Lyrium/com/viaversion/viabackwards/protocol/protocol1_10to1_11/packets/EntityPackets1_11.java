...
public class EntityPackets1_11 extends LegacyEntityRewriter<Protocol1_10To1_11>
{
    ...
    protected void registerRewrites() {
        ...
        this.mapEntityTypeWithData(Entity1_11Types.EntityType.WITHER_SKELETON, Entity1_11Types.EntityType.SKELETON).spawnMetadata(storage -> storage.add(this.getSkeletonTypeMeta(1)));
