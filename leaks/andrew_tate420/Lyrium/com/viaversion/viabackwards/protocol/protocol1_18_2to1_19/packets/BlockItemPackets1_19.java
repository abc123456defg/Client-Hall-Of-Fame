...
public final class BlockItemPackets1_19 extends ItemRewriter<Protocol1_18_2To1_19>
{
    ...
    protected void registerPackets() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    ...
                    for (i = 0; i < size; ++i) {
                        ...
                        BlockItemPackets1_19.this.handleItemToClient(wrapper.passthrough(Type.FLAT_VAR_INT_ITEM));
                        secondItem = wrapper.read(Type.FLAT_VAR_INT_ITEM);
                        if (secondItem != null) {
        ...
        ((Protocol<ClientboundPackets1_19, ClientboundPackets1_18, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_19.BLOCK_CHANGED_ACK, null, new PacketRemapper() {
            @Override
            public void registerMap() {
        ...
        ((AbstractProtocol<ClientboundPackets1_19, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_19.SPAWN_PARTICLE, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    ...
                    particleMappings = ((Protocol1_18_2To1_19)BlockItemPackets1_19.this.protocol).getMappingData().getParticleMappings();
        ...
        ((AbstractProtocol<ClientboundPackets1_19, C2, S1, S2>)this.protocol).registerClientbound(ClientboundPackets1_19.CHUNK_DATA, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                int id;
                this.handler(wrapper -> {
                    tracker = ((Protocol1_18_2To1_19)BlockItemPackets1_19.this.protocol).getEntityRewriter().tracker(wrapper.user());
                    chunkType = new Chunk1_18Type(tracker.currentWorldSectionHeight(), MathUtil.ceilLog2(((Protocol1_18_2To1_19)BlockItemPackets1_19.this.protocol).getMappingData().getBlockStateMappings().mappedSize()), MathUtil.ceilLog2(tracker.biomesSent()));
        ...
        ((AbstractProtocol<C1, C2, S1, ServerboundPackets1_17>)this.protocol).registerServerbound(ServerboundPackets1_17.SET_BEACON_EFFECT, new PacketRemapper() {
            ...
            public void registerMap() {
                ...
                this.handler(wrapper -> {
                    primaryEffect = wrapper.read((Type<Integer>)Type.VAR_INT);
                    if (primaryEffect != -1) {
                        wrapper.write(Type.BOOLEAN, true);
                    ...
                    secondaryEffect = wrapper.read((Type<Integer>)Type.VAR_INT);
