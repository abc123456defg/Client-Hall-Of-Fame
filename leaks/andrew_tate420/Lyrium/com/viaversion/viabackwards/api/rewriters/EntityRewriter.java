...
public abstract class EntityRewriter<T extends BackwardsProtocol> extends EntityRewriterBase<T>
{
    ...
    public PacketHandler getSpawnTrackerWithDataHandler1_19(final EntityType fallingBlockType) {
        ...
        return wrapper -> {
            entityType = this.setOldEntityId(wrapper);
            if (entityType == fallingBlockType) {
                blockState = wrapper.get((Type<Integer>)Type.VAR_INT, 2);
    ...
    public PacketHandler worldTrackerHandlerByKey() {
        ...
        return wrapper -> {
            ...
            world = wrapper.get(Type.STRING, 1);
    ...
    protected EntityType setOldEntityId(final PacketWrapper wrapper) throws Exception {
