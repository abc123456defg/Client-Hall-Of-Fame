...
{
    public static final String MINIMUM_VV_VERSION = "4.4.2";
    public static final String IMPL_VERSION = "git-ViaBackwards-4.4.2-SNAPSHOT:958f265";
    ...
    default void init(final File dataFolder) {
        ...
        Via.getManager().getSubPlatforms().add("git-ViaBackwards-4.4.2-SNAPSHOT:958f265");
    ...
    default boolean isOutdated() {
        ...
        if (vvVersion != null && new Version(vvVersion).compareTo(new Version("4.4.2--")) < 0) {
            this.getLogger().severe("================================");
            this.getLogger().severe("YOUR VIAVERSION IS OUTDATED");
            this.getLogger().severe("PLEASE USE VIAVERSION 4.4.2 OR NEWER");
