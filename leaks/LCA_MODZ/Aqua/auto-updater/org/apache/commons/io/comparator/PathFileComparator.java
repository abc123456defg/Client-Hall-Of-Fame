...
public class PathFileComparator extends AbstractFileComparator implements Serializable
{
    ...
    static {
        ...
        PATH_REVERSE = new ReverseFileComparator(PathFileComparator.PATH_COMPARATOR);
        PATH_INSENSITIVE_COMPARATOR = new PathFileComparator(IOCase.INSENSITIVE);
        PATH_INSENSITIVE_REVERSE = new ReverseFileComparator(PathFileComparator.PATH_INSENSITIVE_COMPARATOR);
        PATH_SYSTEM_COMPARATOR = new PathFileComparator(IOCase.SYSTEM);
        PATH_SYSTEM_REVERSE = new ReverseFileComparator(PathFileComparator.PATH_SYSTEM_COMPARATOR);
    }
}
