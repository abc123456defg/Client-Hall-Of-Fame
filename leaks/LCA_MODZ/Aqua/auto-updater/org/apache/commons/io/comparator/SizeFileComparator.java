...
public class SizeFileComparator extends AbstractFileComparator implements Serializable
{
    ...
    static {
        ...
        SIZE_REVERSE = new ReverseFileComparator(SizeFileComparator.SIZE_COMPARATOR);
        SIZE_SUMDIR_COMPARATOR = new SizeFileComparator(true);
        SIZE_SUMDIR_REVERSE = new ReverseFileComparator(SizeFileComparator.SIZE_SUMDIR_COMPARATOR);
    }
}
