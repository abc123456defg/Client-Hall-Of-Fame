...
public final class TimedValue<T>
{
    ...
    private TimedValue(final T value, final long duration) {
        this.value = value;
    ...
    @NotNull
    public final TimedValue<T> copy-RFiDyg4(final T value, final long duration) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + (Object)Duration.toString-impl(this.duration) + ')';
    }
