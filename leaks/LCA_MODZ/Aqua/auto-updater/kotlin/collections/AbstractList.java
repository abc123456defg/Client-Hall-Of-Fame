...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E>, KMappedMarker
{
    ...
    public int indexOf(final E element) {
        final List $this$indexOfFirst$iv = this;
        final int $i$f$indexOfFirst = 0;
        int index$iv = 0;
        for (final Object it : $this$indexOfFirst$iv) {
    ...
    public int lastIndexOf(final E element) {
        final List $this$indexOfLast$iv = this;
        final int $i$f$indexOfLast = 0;
        final ListIterator iterator$iv = $this$indexOfLast$iv.listIterator($this$indexOfLast$iv.size());
    ...
    private class ListIteratorImpl extends IteratorImpl implements ListIterator<E>, KMappedMarker
    {
        ...
        public E previous() {
            ...
            final AbstractList<E> this$0 = AbstractList.this;
    ...
    public static final class Companion
    {
        ...
        public final void checkBoundsIndexes$kotlin_stdlib(final int startIndex, final int endIndex, final int size) {
