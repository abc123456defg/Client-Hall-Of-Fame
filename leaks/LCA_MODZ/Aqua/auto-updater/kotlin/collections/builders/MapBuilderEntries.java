...
public final class MapBuilderEntries<K, V> extends AbstractMapBuilderEntrySet<Map.Entry<K, V>, K, V>
{
    ...
    public MapBuilderEntries(@NotNull final MapBuilder<K, V> backing) {
    ...
    @Override
    public boolean containsEntry(@NotNull final Map.Entry<? extends K, ? extends V> element) {
    ...
    @Override
    public boolean add(@NotNull final Map.Entry<K, V> element) {
        Intrinsics.checkNotNullParameter(element, "element");
        throw new UnsupportedOperationException();
    }
    
    @Override
    public boolean addAll(@NotNull final Collection<? extends Map.Entry<K, V>> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        throw new UnsupportedOperationException();
    }
    
    public boolean remove(@NotNull final Map.Entry element) {
        Intrinsics.checkNotNullParameter(element, "element");
