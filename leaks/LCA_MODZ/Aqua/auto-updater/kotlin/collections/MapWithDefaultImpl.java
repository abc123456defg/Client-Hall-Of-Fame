...
final class MapWithDefaultImpl<K, V> implements MapWithDefault<K, V>
{
    ...
    public MapWithDefaultImpl(@NotNull final Map<K, ? extends V> map, @NotNull final Function1<? super K, ? extends V> default) {
        Intrinsics.checkNotNullParameter(map, "map");
        Intrinsics.checkNotNullParameter(default, "default");
        this.map = (Map<K, V>)map;
        this.default = (Function1<K, V>)default;
    }
    ...
    @Override
    public V getOrImplicitDefault(final K key) {
        final Map $this$getOrElseNullable$iv = this.getMap();
        ...
        if (value$iv == null && !$this$getOrElseNullable$iv.containsKey(key)) {
            final int n = 0;
            invoke = this.default.invoke(key);
        }
        else {
            invoke = value$iv;
        }
