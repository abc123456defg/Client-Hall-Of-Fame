...
public interface ClosedRange<T extends Comparable<? super T>>
{
    ...
    {
        public static <T extends Comparable<? super T>> boolean contains(@NotNull final ClosedRange<T> $this, @NotNull final T value) {
            Intrinsics.checkNotNullParameter(value, "value");
            return value.compareTo((Object)$this.getStart()) >= 0 && value.compareTo((Object)$this.getEndInclusive()) <= 0;
        }
        
        public static <T extends Comparable<? super T>> boolean isEmpty(@NotNull final ClosedRange<T> $this) {
