...
final class OpenEndFloatRange implements OpenEndRange<Float>
{
    ...
    public OpenEndFloatRange(final float start, final float endExclusive) {
        this._start = start;
    ...
    private final boolean lessThanOrEquals(final float a, final float b) {
        return a <= b;
    }
    ...
    @Override
    public int hashCode() {
        return this.isEmpty() ? -1 : (31 * Float.valueOf(this._start).hashCode() + Float.valueOf(this._endExclusive).hashCode());
    }
