...
class ComparisonsKt__ComparisonsKt
{
    ...
    private static final <T> int compareValuesByImpl$ComparisonsKt__ComparisonsKt(final T a, final T b, final Function1<? super T, ? extends Comparable<?>>[] selectors) {
        for (int i = 0; i < selectors.length; ++i) {
            final Function1 fn = selectors[i];
    ...
    public static final <T> Comparator<T> reversed(@NotNull final Comparator<T> $this$reversed) {
        ...
        if ($this$reversed instanceof ReversedComparator) {
            ...
            final ReverseOrderComparator instance = ReverseOrderComparator.INSTANCE;
            Intrinsics.checkNotNull(instance, "null cannot be cast to non-null type java.util.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.reversed>{ kotlin.TypeAliasesKt.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.reversed> }");
            comparator = instance;
        }
            ...
            Intrinsics.checkNotNull(instance2, "null cannot be cast to non-null type java.util.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.reversed>{ kotlin.TypeAliasesKt.Comparator<T of kotlin.comparisons.ComparisonsKt__ComparisonsKt.reversed> }");
