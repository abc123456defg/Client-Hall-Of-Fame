...
class IntrinsicsKt__IntrinsicsKt extends IntrinsicsKt__IntrinsicsJvmKt
{
    ...
    @InlineOnly
    private static final <T> Object suspendCoroutineUninterceptedOrReturn(final Function1<? super Continuation<? super T>, ?> block, final Continuation<? super T> $completion) {
