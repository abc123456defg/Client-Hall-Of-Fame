...
public abstract class AbstractCoroutineContextKey<B extends Element, E extends B> implements Key<E>
{
    ...
    public AbstractCoroutineContextKey(@NotNull final Key<B> baseKey, @NotNull final Function1<? super Element, ? extends E> safeCast) {
    ...
    @Nullable
    public final E tryCast$kotlin_stdlib(@NotNull final Element element) {
        Intrinsics.checkNotNullParameter(element, "element");
        return this.safeCast.invoke(element);
    }
    
    public final boolean isSubKey$kotlin_stdlib(@NotNull final Key<?> key) {
