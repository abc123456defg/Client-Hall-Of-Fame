...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable
{
    ...
    public final void resumeWith(@NotNull final Object result) {
        ...
        while (true) {
            ...
            final BaseContinuationImpl $this$resumeWith_u24lambda_u240 = (BaseContinuationImpl)current;
            final int n = 0;
            final Continuation<Object> completion2 = $this$resumeWith_u24lambda_u240.completion;
            Intrinsics.checkNotNull(completion2);
            completion = completion2;
            Object o;
            try {
                final Object outcome = $this$resumeWith_u24lambda_u240.invokeSuspend(param);
    ...
    public CoroutineStackFrame getCallerFrame() {
        ...
        return (completion instanceof CoroutineStackFrame) ? completion : null;
    }
