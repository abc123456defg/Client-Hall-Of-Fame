...
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements FunctionBase<Object>, SuspendFunction
{
    ...
    public RestrictedSuspendLambda(final int arity, @Nullable final Continuation<Object> completion) {
        super(completion);
        this.arity = arity;
    }
    ...
    public RestrictedSuspendLambda(final int arity) {
        this(arity, null);
    }
    ...
    public String toString() {
        ...
        if (this.getCompletion() == null) {
            Intrinsics.checkNotNullExpressionValue(s = Reflection.renderLambdaToString(this), "renderLambdaToString(this)");
        }
        else {
            s = super.toString();
        }
