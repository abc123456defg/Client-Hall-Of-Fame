...
public final class ContinuationKt
{
    ...
    @InlineOnly
    private static final <T> void resume(final Continuation<? super T> $this$resume, final T value) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T> void resumeWithException(final Continuation<? super T> $this$resumeWithException, final Throwable exception) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <T> Object suspendCoroutine(final Function1<? super Continuation<? super T>, Unit> block, final Continuation<? super T> $completion) {
        InlineMarker.mark(0);
        final Continuation c = $completion;
        final int n = 0;
