...
public abstract class ObservableProperty<V> implements ReadWriteProperty<Object, V>
{
    ...
    public ObservableProperty(final V initialValue) {
        this.value = initialValue;
    }
    
    protected boolean beforeChange(@NotNull final KProperty<?> property, final V oldValue, final V newValue) {
        Intrinsics.checkNotNullParameter(property, "property");
        return true;
    }
    
    protected void afterChange(@NotNull final KProperty<?> property, final V oldValue, final V newValue) {
        Intrinsics.checkNotNullParameter(property, "property");
    }
    
    @Override
    public V getValue(@Nullable final Object thisRef, @NotNull final KProperty<?> property) {
        Intrinsics.checkNotNullParameter(property, "property");
        return this.value;
    }
    
    @Override
    public void setValue(@Nullable final Object thisRef, @NotNull final KProperty<?> property, final V value) {
        Intrinsics.checkNotNullParameter(property, "property");
