...
{
    @NotNull
    public static final <T> Lazy<T> lazyOf(final T value) {
        return new InitializedLazyImpl<T>(value);
    }
    
    @InlineOnly
    private static final <T> T getValue(final Lazy<? extends T> $this$getValue, final Object thisRef, final KProperty<?> property) {
