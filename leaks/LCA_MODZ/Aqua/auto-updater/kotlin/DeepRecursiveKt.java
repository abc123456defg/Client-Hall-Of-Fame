...
public final class DeepRecursiveKt
{
    ...
    public static final <T, R> R invoke(@NotNull final DeepRecursiveFunction<T, R> $this$invoke, final T value) {
    ...
    static {
        ...
        UNDEFINED_RESULT = Result.constructor-impl(IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }
}
