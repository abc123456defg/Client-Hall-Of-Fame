...
{
    @InlineOnly
    private static final Regex toRegex(final String $this$toRegex) {
        Intrinsics.checkNotNullParameter($this$toRegex, "<this>");
        return new Regex($this$toRegex);
    }
    
    @InlineOnly
    private static final Regex toRegex(final String $this$toRegex, final RegexOption option) {
        Intrinsics.checkNotNullParameter($this$toRegex, "<this>");
    ...
    @InlineOnly
    private static final Regex toRegex(final String $this$toRegex, final Set<? extends RegexOption> options) {
        Intrinsics.checkNotNullParameter($this$toRegex, "<this>");
