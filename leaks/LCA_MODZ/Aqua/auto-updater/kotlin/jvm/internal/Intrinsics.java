...
public class Intrinsics
{
    ...
    @SinceKotlin(version = "1.4")
    public static void throwJavaNpe(final String message) {
    ...
    public static void checkNotNullExpressionValue(final Object value, final String expression) {
        if (value == null) {
    ...
    public static void checkNotNullParameter(final Object value, final String paramName) {
        if (value == null) {
            throwParameterIsNullNPE(paramName);
        }
    }
    
    private static void throwParameterIsNullIAE(final String paramName) {
        throw sanitizeStackTrace(new IllegalArgumentException(createParameterIsNullExceptionMessage(paramName)));
    }
    
    private static void throwParameterIsNullNPE(final String paramName) {
        throw sanitizeStackTrace(new NullPointerException(createParameterIsNullExceptionMessage(paramName)));
    }
    
    private static String createParameterIsNullExceptionMessage(final String paramName) {
