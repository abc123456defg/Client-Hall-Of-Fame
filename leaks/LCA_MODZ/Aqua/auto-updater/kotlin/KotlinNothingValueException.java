...
public final class KotlinNothingValueException extends RuntimeException
{
    ...
    public KotlinNothingValueException(@Nullable final String message) {
        super(message);
    }
    
    public KotlinNothingValueException(@Nullable final String message, @Nullable final Throwable cause) {
        super(message, cause);
    }
    
    public KotlinNothingValueException(@Nullable final Throwable cause) {
        super(cause);
    }
}
