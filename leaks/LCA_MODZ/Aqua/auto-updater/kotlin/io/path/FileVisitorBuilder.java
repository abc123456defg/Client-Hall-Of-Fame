...
{
    void onPreVisitDirectory(@NotNull final Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> p0);
    
    void onVisitFile(@NotNull final Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> p0);
    
    void onVisitFileFailed(@NotNull final Function2<? super Path, ? super IOException, ? extends FileVisitResult> p0);
    
    void onPostVisitDirectory(@NotNull final Function2<? super Path, ? super IOException, ? extends FileVisitResult> p0);
}
