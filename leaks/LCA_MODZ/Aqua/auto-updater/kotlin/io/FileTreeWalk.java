...
public final class FileTreeWalk implements Sequence<File>
{
    ...
    private final class FileTreeWalkIterator extends AbstractIterator<File>
    {
        ...
        private final DirectoryState directoryState(final File root) {
            ...
            switch (WhenMappings.$EnumSwitchMapping$0[FileTreeWalk.access$getDirection$p(FileTreeWalk.this).ordinal()]) {
                case 1: {
        ...
        private final class BottomUpDirectoryState extends DirectoryState
        {
            ...
            public File step() {
                if (!this.failed && this.fileList == null) {
                    ...
                    if (access$getOnEnter$p != null && !access$getOnEnter$p.invoke(((WalkState)this).getRoot())) {
                        return null;
                    }
                    ...
                    if (this.fileList == null) {
                        ...
                        if (access$getOnFail$p != null) {
                            access$getOnFail$p.invoke(((WalkState)this).getRoot(), new AccessDeniedException(((WalkState)this).getRoot(), null, "Cannot list files in a directory", 2, null));
                        }
                        this.failed = true;
                    }
                }
                ...
                if (access$getOnLeave$p != null) {
                    access$getOnLeave$p.invoke(((WalkState)this).getRoot());
                }
                return null;
            }
        }
                    ...
                    Label_0205: {
                        if (this.fileList == null) {
                            ...
                            if (access$getOnLeave$p2 != null) {
                                access$getOnLeave$p2.invoke(((WalkState)this).getRoot());
                            }
                            return null;
                        }
                    }
