...
public final class TransformingSequence<T, R> implements Sequence<R>
{
    ...
    public TransformingSequence(@NotNull final Sequence<? extends T> sequence, @NotNull final Function1<? super T, ? extends R> transformer) {
    ...
    @NotNull
    public final <E> Sequence<E> flatten$kotlin_stdlib(@NotNull final Function1<? super R, ? extends Iterator<? extends E>> iterator) {
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return new FlatteningSequence<Object, Object, E>(this.sequence, this.transformer, iterator);
    }
}
