...
public final class DropWhileSequence<T> implements Sequence<T>
{
    ...
    public DropWhileSequence(@NotNull final Sequence<? extends T> sequence, @NotNull final Function1<? super T, Boolean> predicate) {
    ...
    public Iterator<T> iterator() {
        return (Iterator<T>)new DropWhileSequence$iterator.DropWhileSequence$iterator$1(this);
    }
}
