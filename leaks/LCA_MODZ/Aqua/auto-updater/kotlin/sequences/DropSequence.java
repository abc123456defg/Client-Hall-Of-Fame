...
public final class DropSequence<T> implements Sequence<T>, DropTakeSequence<T>
{
    ...
    public Sequence<T> take(final int n) {
        final int n2 = this.count + n;
        final int n3 = 0;
        return (DropTakeSequence<T>)((n2 < 0) ? ((TakeSequence<Object>)new TakeSequence<Object>(this, n)) : ((SubSequence<Object>)new SubSequence<Object>(this.sequence, this.count, n2)));
    }
