...
public final class ConstrainedOnceSequence<T> implements Sequence<T>
{
    ...
    public ConstrainedOnceSequence(@NotNull final Sequence<? extends T> sequence) {
    ...
    public Iterator<T> iterator() {
        final Sequence<T> sequence2 = this.sequenceRef.getAndSet(null);
        if (sequence2 == null) {
            throw new IllegalStateException("This sequence can be consumed only once.");
        }
        final Sequence sequence = sequence2;
