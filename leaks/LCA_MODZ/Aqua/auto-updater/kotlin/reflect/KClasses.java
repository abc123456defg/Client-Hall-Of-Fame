...
public final class KClasses
{
    ...
    @NotNull
    public static final <T> T cast(@NotNull final KClass<T> $this$cast, @Nullable final Object value) {
        Intrinsics.checkNotNullParameter($this$cast, "<this>");
        if (!$this$cast.isInstance(value)) {
            final StringBuilder append = new StringBuilder().append("Value cannot be cast to ");
            final KClass $this$qualifiedOrSimpleName$iv = $this$cast;
            final int $i$f$getQualifiedOrSimpleName = 0;
            throw new ClassCastException(append.append($this$qualifiedOrSimpleName$iv.getQualifiedName()).toString());
        }
    ...
    @LowPriorityInOverloadResolution
    @Nullable
    public static final <T> T safeCast(@NotNull final KClass<T> $this$safeCast, @Nullable final Object value) {
